...
function trustdetails(props:any): any {
...
function ratingDetails(props:any): any {
  return (<RatingComponent value={props.Rating} cssClass={'custom-rating'} readOnly={true} />);
}
function statusdetails(props:any): any {
...
function OverView(this: any) {
  ...
  let ddObj: DropDownListComponent | any ;
  ...
  function onLoad(args: any): void {
    ...
    (document.getElementById('overviewgrid') as any).addEventListener('DOMSubtreeModified', () => {
